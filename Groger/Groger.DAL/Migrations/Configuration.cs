    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GrogerContext>
    {
        ...
        protected override void Seed(GrogerContext context)
        {
           ...
           context.Groceries.AddOrUpdate(x => x.Id,
                new Grocery() { Id = 1, Name = "Sel de mer", Description = "Sel la balaine", Quantity = 2, ClusterId = 1, CategoryId = 1 },
                new Grocery() { Id = 2, Name = "Poivre", Description = "Poivre 5 baies", Quantity = 1, ClusterId = 1, CategoryId = 1 },
                new Grocery() { Id = 3, Name = "Côtes de porc", Description = "Côtes de porc", Quantity = 4, ClusterId = 1, CategoryId = 1 },
                new Grocery() { Id = 4, Name = "Cuisse de poulet", Description = "Poulet de louet", Quantity = 1, ClusterId = 1, CategoryId = 1 }
                );
